...
use crate::{helpers::physx_vec3, PhysXRes, PxRigidDynamic, DynamicActor, PxRigidActorHandle};
...
pub fn px_apply_forces(
    physx: Res<PhysXRes>,
    mut query: Query<(&PxRigidActorHandle, &mut PxExternalForce), Or<(With<DynamicActor>, With<crate::sync_physx::articulation::ArticulationLink>)>>,
